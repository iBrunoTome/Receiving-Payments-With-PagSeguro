...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = "YOUR_PAGSEGURO_TOKEN";
    /**
     *
     */
    const PAGSEGURO_TOKEN_SANDBOX = "NULL";
    /**
     *
     */
    const PAGSEGURO_APP_ID_PRODUCTION = "NULL";
    /**
     *
     */
    const PAGSEGURO_APP_ID_SANDBOX = "NULL";
    /**
     *
     */
    const PAGSEGURO_APP_KEY_PRODUCTION = "NULL";
    /**
     *
     */
    const PAGSEGURO_APP_KEY_SANDBOX = "NULL";
    /**
     * UTF-8, ISO-8859-1
     */
